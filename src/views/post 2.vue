    ...
    <div class="post_page_body">
        ...
        <div class="main">
            <div style="width: 100vw;position: relative;margin-top: 0px;background: transparent;height: auto;" class="top_img">
                ...
                <div class="top_items" style="display: flex; flex-direction: column;margin-top: 40px;">
                    <!-- <div style="display: flex; flex-direction:column;align-self: center;"> -->
                    <p style="font-size: 24px;font-weight: 900;color: black;padding: 0px;margin: 0px;text-align: left;margin-left: 5vw;">{{ this.title }}</p>
                    <p style="font-size: 17px;font-weight: 400;color: #9E9E9E;padding: 0px;margin: 0px;padding-top: 10px;text-align: left;margin-left: 5vw;">{{ this.description }}</p>
                    <!-- </div> -->
                ...
                <pre style="line-height: 22px;font-size: 16px;font-family: 'Quicksand'; padding: 0px; white-space: pre-wrap;text-align: left;padding-top: 20px; padding-bottom: 20px; padding-right: 5vw;margin-left: 5vw;">{{ this.bodyText }}</pre>
                <div class="comments_section" style="margin-top: 10vh;margin-bottom: 10vh;text-align: left;margin-left: 5vw;">
                    ...
                    <button @click="this.send_comment" style="all: unset;padding: 15px;background: #E34848;color: white;font-weight: 500;font-size: 16px; margin-top: 20px;cursor: pointer;border-radius: 100000px;padding-left: 30px; padding-right: 30px;">Comment</button>
