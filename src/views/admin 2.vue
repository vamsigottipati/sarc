    ...
    methods: {
        ...
        submit_category () {
            ...
            if(this.new_category) {
                ...
                this.$http.post('https://sarc-bphc-backend.herokuapp.com/api/home/new_categorie', newCat).then(() => {
                    // console.log(resp)
                    vm.new_category = ''
            ...
            if (this.title && this.post_tagline && this.description && this.selected_category != 'Choose a category') {
              firebase.storage().ref('post_pics/' + randomString + uc.name).put(uc).then(resp => {
                  resp.ref.getDownloadURL().then(rsp => {
                    ...
                    this.$http.post('https://sarc-bphc-backend.herokuapp.com/api/home/posts', data_json).then(() => {
                        // console.log(resp)
